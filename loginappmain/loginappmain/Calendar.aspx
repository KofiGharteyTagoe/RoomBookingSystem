        ...
        <div class="container">
                ...
                <div class="calendarDiv">
                 ...
                 <asp:Panel ID="Panel2" runat="server">
                     <asp:Calendar ID="Calendar1" runat="server" BorderStyle="Inset" BorderWidth="2px" DayNameFormat="Full" Font-Bold="True" Font-Names="Arial" Height="500px" NextMonthText="Next &amp;gt;" OnDayRender="Calendar1_DayRender" PrevMonthText="&amp;lt; Previous" ShowGridLines="True" Width="700px" OnSelectionChanged="Calendar1_SelectionChanged">
