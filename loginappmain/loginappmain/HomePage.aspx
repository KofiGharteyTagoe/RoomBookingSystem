                            ...
                            <table class="auto-style3">
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblID1" runat="server" Text="ID: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblID2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblRoom1" runat="server" Text="Room ID: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblRoom2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblDate1" runat="server" Text="Booking Date: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblDate2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblSTime1" runat="server" Text="Start Time: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblSTime2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblETime1" runat="server" Text="End Time: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblETime2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblBooked1" runat="server" Text="Booked By: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblBooked2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblType1" runat="server" Text="BookingType: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblType2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td class="auto-style4">
                                        <asp:Label ID="lblDescription1" runat="server" Text="Description: " ClientIDMode="Static" Font-Bold="True"></asp:Label></td>
                                    <td>
                                        <asp:Label ID="lblDescription2" runat="server" ClientIDMode="Static"></asp:Label><br />
                                    </td>
                                </tr>
                                <tr>
