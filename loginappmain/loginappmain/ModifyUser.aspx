    ...
    <div class="Pagename">
        ...
        <div class="container">
            ...
            <div class="SearchAccDiv2">
                ...
                <br />
                <asp:GridView ID="userDataGrid" runat="server" AllowPaging="True" AutoGenerateColumns="False" BackColor="White" BorderColor="#CC9966" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="UserID" DataSourceID="SqlDataSource1" Style="text-align: center" HorizontalAlign="Center">
                    <Columns>
                ...
                <table class="createUser" align="center">
                    ...
                    <tr>
                        ...
                        <td class="auto-style24">
                            <asp:TextBox CssClass="createUserTextbox" ID="txt_userID" runat="server"></asp:TextBox>
                        </td>
